...
echo -e "--------------------------------------------------"
echo -e "1. Create a \033[1;33m.env\033[0m file and store your keys in this format:"
echo -e "   \033[1;32mOPENROUTER_API_KEY\033[0m=\"YOUR_API_KEY\""
echo -e "   \033[1;32mFINBERT_MODEL_PATH\033[0m=ProsusAI/finbert"
echo -e "   \033[1;32mHF_TOKEN\033[0m=\"YOUR_HUGGING_FACE_TOKEN\""
echo -e "2. Ensure \033[1;33mconfig.py\033[0m is configured to read from .env."
echo -e "3. Run: \033[1;36msource .venv/bin/activate && python tool.py\033[0m"
echo -e "--------------------------------------------------"
